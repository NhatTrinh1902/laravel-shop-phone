...

{
    ...
    {
        $featuredProducts = Product::where('product_category', 1)->get(); // category = 1 là nổi bật
        return view('users.index', compact('featuredProducts'));
    }
    ...
    {
        $products = Product::where('product_category', (int)$categoryId)->get();
        return view('users.category', compact('products'));
    }
